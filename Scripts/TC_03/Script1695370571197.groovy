...
WebUI.click(findTestObject('Object Repository/Page_Get Firefox for desktop  Mozilla (US)/h4_Privacy Promise'))

WebUI.verifyElementText(findTestObject('Object Repository/Page_Firefox Privacy Promise/h1_Firefox products are designed to protect_73a558'), 
